<x-app-layout>
                            ...
                            <div class="owl-carousel owl-theme none dots-none">
                                <div class="item-slider-1">
                                    ...
                                    <div class="box-feature">
                                        <div class="image">
                                            <img src="{{ front_asset('images/common/slider-1.png')}}" alt="Image">
                                        </div>
                                    </div>
                                </div>
                                <div class="item-slider-1">
                                    <div class="box-content">
                                        ...
                                        <div class="box-btn">
                                            <a href="#" class="fl-btn st-12">
                                                <span class="inner">COntact Us</span>
                                            </a>
                                            <a href="#" class="fl-btn st-1">
                                                <span class="inner">learn more</span>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-12">
                    <div class="title-heading st-2">
                        <div class="sub-heading clr-pri-1 f-mulish">
                            ...
                            <span class="inner-sub st-1">Why Choose Us</span>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="77" height="30" viewBox="0 0 77 30">
                                <g>
                                    <image width="77" height="30"
                        ...
                        <h2 class="title clr-pri-1">Discover Now Why People
                            Come With Kindco</h2>
                    </div>
                </div>
                    ...
                    <div class="sc-about-3">
                        ...
                        <div class="sc-about-content">
                            <div class="title-heading">
                                <div class="sub-heading clr-pri-3 f-mulish"><span class="inner-sub st-2">About Us</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="77" height="30" viewBox="0 0 77 30">
                                        <g>
                                            <image width="77" height="30"
                ...
                <div class="col-12">
                    <div class="slider-courses">
                        <div class="themesflat-carousel clearfix" data-margin="30" data-item="3" data-item2="3"
                            data-item3="2" data-item4="1" data-auto="false" data-nav="true" data-loop="true">
                            <div class="owl-carousel owl-theme none">
                                <div data-dot="" class="item-courses wow fadeIn animated" data-wow-delay="0.3ms"
                                    ...
                                    <div class="box-feature">
                                        <img src="{{ front_asset('images/common/slider-courses-1.jpg')}}" alt="Image">
                                    </div>
                                    <div class="box-content">
                                        <div class="box-wrap">
                                            <h4 class="title"><a href="classe-details.html">Drawing & Painting</a></h4>
                                            <p class="sub f-mulish">Consectetur adipiscing elit seds eiusmo tempor
                                                incide
                                            </p>
                                        </div>
                                        <ul>
                                ...
                                <div data-dot="" class="item-courses wow fadeIn animated" data-wow-delay="0.3ms"
                                    data-wow-duration="1300ms">
                                    <div class="box-feature">
                                        <img src="{{ front_asset('images/common/slider-courses-2.jpg')}}" alt="Image">
                                    </div>
                                    <div class="box-content">
                                        <div class="box-wrap">
                                ...
                                <div data-dot="" class="item-courses wow fadeIn animated" data-wow-delay="0.3ms"
                                    data-wow-duration="1300ms">
                                    <div class="box-feature">
                                        <img src="{{ front_asset('images/common/slider-courses-3.jpg')}}" alt="Image">
                                    </div>
                                    <div class="box-content">
                                        <div class="box-wrap">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="slider-employee">
                        <div class="themesflat-carousel clearfix" data-margin="30" data-item="4" data-item2="3"
                            data-item3="2" data-item4="1" data-auto="false">
                            <div class="owl-carousel owl-theme none dots-none">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="slider-gallery">
                        <div class="themesflat-carousel clearfix" data-margin="30" data-item="4" data-item2="4"
                            data-item3="2" data-item4="1" data-auto="false">
                            <div class="owl-carousel owl-theme none dots-none">
                                <div class="sc-gallery-2 st-1 wow fadeIn animated" data-wow-delay="0.5ms"
                                    data-wow-duration="1200ms">
                                    <img src="{{ front_asset('images/common/sc-gallery-6.jpg')}}" alt="Image">
                                    <div class="overlay">
                                        <div class="inner-overlay">
                                            ...
                                            <h3><a href="gallery.html" class="clr-pri-1">Student Playing</a></h3>
                                        </div>
                                    </div>
                                </div>

                                <div class="sc-gallery-2 wow fadeIn animated" data-wow-delay="0.5ms"
                                    data-wow-duration="1200ms">
                                    <img src="{{ front_asset('images/common/sc-gallery-7.jpg')}}" alt="Image">
                                    <div class="overlay">
                                        <div class="inner-overlay">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                                viewBox="0 0 100 100">
                                ...
                                <div class="sc-gallery-2 st-1 wow fadeIn animated" data-wow-delay="0.5ms"
                                    data-wow-duration="1200ms">
                                    <img src="{{ front_asset('images/common/sc-gallery-8.jpg')}}" alt="Image">
                                    <div class="overlay">
                                        <div class="inner-overlay">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                                viewBox="0 0 100 100">
                                ...
                                <div class="sc-gallery-2 st-2 wow fadeIn animated" data-wow-delay="0.5ms"
                                    data-wow-duration="1200ms">
                                    <img src="{{ front_asset('images/common/sc-gallery-9.jpg')}}" alt="Image">
                                    <div class="overlay">
                                        <div class="inner-overlay">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                                viewBox="0 0 100 100">
    ...
    <section class="tf-section tf-service-2">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="fl-services fx">
                        <div class="box-feature fx wow fadeIn animated" data-wow-delay="0.3ms"
                            data-wow-duration="1300ms">
                            <img src="{{ front_asset('images/pattern/service-2.png')}}" alt="Image">
                        </div>
                        <div class="box-content">
                            <div class="title-heading">
                                <div class="sub-heading clr-pri-3 f-mulish"><span class="inner-sub st-2">Why Choose
                                        Us</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="77" height="30" viewBox="0 0 77 30">
                                        <g>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-heading st-3">
                        ...
                        <h2 class="title clr-pri-2">What Parents Say About Our <span class="clr-pri-3">Kindco</span>
                            Kindergarten</h2>
                    </div>
                </div>
                <div class="col-12 pd0-135">
                    <div class="slider-fb">
                        <div class="themesflat-carousel clearfix" data-margin="66" data-item="2" data-item2="2"
                            data-item3="1" data-item4="1" data-auto="false">
                            <div class="owl-carousel owl-theme none">
                                <div data-dot="" class="item-fb wow fadeIn animated" data-wow-delay="0.3ms"
                                    data-wow-duration="1300ms">
                                    <div class="heading fx">
                                        <div class="box-avt">
                                            <img src="{{ front_asset('images/thumbnails/avt-quote.jpg')}}" alt="Image">
                                        </div>
                                        <ul>
                                            <li>
                                                <h4 class="name-author clr-pri-2">Bradley Y. Grimes</h4>
                                            </li>
                                            <li>
                                                <p class="clr-pri-5 f-mulish">Senior Manager</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="wrap">
                                        <p class="clr-pri-2">“ On the other hand denounce with righteous indignation and
                                ...
                                <div data-dot="" class="item-fb wow fadeIn animated" data-wow-delay="0.3ms"
                                    ...
                                    <div class="heading fx">
                                        <div class="box-avt">
                                            <img src="{{ front_asset('images/thumbnails/avt-quote-2.jpg')}}"
                                                alt="Image">
                                        </div>
                                        <ul>
                                            <li>
    ...
    <section class="tf-section tf-register">
        <img src="{{ front_asset('images/background/bg-register.png')}}" alt="Image" class="feature-register">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title-heading st-5">
                        <div class="sub-heading clr-pri-3 f-mulish">
                            ...
                            <span class="inner-sub st-1">Online Registations</span>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="77" height="30" viewBox="0 0 77 30">
                                <g>
                                    <image width="77" height="30"
                        ...
                        <h2 class="title clr-pri-2">Admission Going On ! Hurry Up
                            To Admit Your Seat</h2>
                    </div>
                </div>
                <div class="col-12">
                    <div class="fl-register wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                        <form action="contact/contact-process.php" method="post" id="commentform" class="comment-form">
                            <div class="row-form st-1 mg-bt-20"><input type="text" id="name" name="name"
                                    placeholder="Full Name.........."></div>
                            <div class="row-form st-1 mg-bt-20">
                                <input type="text" placeholder="Progam.........." id="progam" name="progam">
                                <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="21" height="17"
                                    viewBox="0 0 21 17">
                                    <g data-name="02">
                                        <image width="21" height="17"
                                            xlink:href="data:img/png;base64," />
                                    </g>
                                </svg>
                            </div>
                            <div class="row-form st-1">
                                <input type="text" placeholder="Time/Shift.........." id="time-ship" name="time-ship">
                                <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="21" height="17"
                                    viewBox="0 0 21 17">
                                    <g data-name="02">
                            ...
                            <div class="row-form"><button class="fl-btn st-14"><span class="inner">Enroll
                                        Courses</span></button></div>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="heading st-1">
                        <div class="title-heading">
                            <div class="sub-heading clr-pri-3 f-mulish"><span class="inner-sub st-2">Latest News & Blog
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="77" height="30" viewBox="0 0 77 30">
                                    <g>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                    <div class="sc-artice wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
                        ...
                        <div class="box-content">
                            <div class="meta-post">
                                <ul class="fx">
                                    <li><a href="#" class="fx clr-pri-5"><i class="far fa-calendar-alt clr-pri-5"></i>25
                                            Dec
                                            2021</a></li>
                                    <li><a href="#" class="fx clr-pri-5"><i
                                                class="far fa-comment-alt-dots clr-pri-5"></i>Com (05)</a></li>
                                </ul>
                            </div>
                            <h4 class="title-article-post"><a href="blog-single.html">Useful VS Code Extensions Front
                                    End
                                    Developer</a></h4>
                            <p class="wrap f-mulish">Sit amet consectetur adipiscing sedey
                                eiusmod tempor incididunt</p>
                            <div class="btn-rm">
                                <a href="blog-single.html" class="fl-btn st-13">
                                    <span class="inner">read more</span>
                                </a>
                            </div>
                        </div>
